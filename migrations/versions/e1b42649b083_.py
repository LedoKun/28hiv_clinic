...
Revision ID: e1b42649b083
Revises: 
Create Date: 2019-05-27 06:45:20.899930
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "phoneNumbers", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "riskBehaviors", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "arvMedications", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.Column("whySwitchingARV", sa.Unicode(), nullable=True),
        sa.Column(
            "tbMedications", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.Column(
            "oiMedications", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.Column(
            "medications", postgresql.ARRAY(sa.Unicode()), nullable=True
        ),
        sa.Column("patientID", postgresql.UUID(as_uuid=True), nullable=True),
        sa.ForeignKeyConstraint(["patientID"], ["patient.id"]),
        sa.PrimaryKeyConstraint("id"),
